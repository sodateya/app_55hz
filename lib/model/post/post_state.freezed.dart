...
mixin _$PostState {
  ...
  DocumentSnapshot<Post>? get lastDoc => throw _privateConstructorUsedError;
...
abstract class $PostStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Post> posts, DocumentSnapshot<Post>? lastDoc});
}
...
class _$PostStateImpl implements _PostState {
  const _$PostStateImpl({final List<Post> posts = const [], this.lastDoc})
      : _posts = posts;
  ...
  @override
  final DocumentSnapshot<Post>? lastDoc;

  @override
  String toString() {
    return 'PostState(posts: $posts, lastDoc: $lastDoc)';
  }
...
abstract class _PostState implements PostState {
  const factory _PostState(
      ...
      final DocumentSnapshot<Post>? lastDoc}) = _$PostStateImpl;

  @override
  List<Post> get posts;
  @override
  DocumentSnapshot<Post>? get lastDoc;
  @override
  @JsonKey(ignore: true)
  _$$PostStateImplCopyWith<_$PostStateImpl> get copyWith =>
      throw _privateConstructorUsedError;
